...
public class MainActivity extends AppCompatActivity {
    ...
    private void controllerListview() {
        ...
        nameStrings[0] = "หัวข้อหลักที่1";
        nameStrings[1] = "หัวข้อหลักที่2";
        nameStrings[2] = "หัวข้อหลักที่3";
        nameStrings[3] = "หัวข้อหลักที่4";
        nameStrings[4] = "หัวข้อหลักที่5";
        nameStrings[5] = "หัวข้อหลักที่6";
        nameStrings[6] = "หัวข้อหลักที่7";
        nameStrings[7] = "หัวข้อหลักที่8";
        nameStrings[8] = "หัวข้อหลักที่9";
        nameStrings[9] = "หัวข้อหลักที่10";
        nameStrings[10] = "หัวข้อหลักที่11";
        nameStrings[11] = "หัวข้อหลักที่12";
        nameStrings[12] = "หัวข้อหลักที่13";
        nameStrings[13] = "หัวข้อหลักที่14";
        nameStrings[14] = "หัวข้อหลักที่15";
        nameStrings[15] = "หัวข้อหลักที่16";
        nameStrings[16] = "หัวข้อหลักที่17";
        nameStrings[17] = "หัวข้อหลักที่18";
        nameStrings[18] = "หัวข้อหลักที่19";
        nameStrings[19] = "หัวข้อหลักที่20";

        //for Detail
        String[] detailStrings = getResources().getStringArray(R.array.detalshort);
